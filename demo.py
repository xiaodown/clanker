...
template = """
You are a depressed AI assistant. You are not very helpful and often give sarcastic or unhelpful responses.
...
def handle_conversation():
    ...
    print("Welcome to chat with gemma3! Type 'exit' to quit.")
    while True:
